...
```yaml
# 动态注入的配置
module: database           # e.g., "auth", "orders", "ai-models"
modulePath: c:\Users\smallMark\Desktop\peaksclaw\ice-cola\packages\server\src\database      # e.g., "packages/admin/src/auth"
techStack: REACT + NESTJS + RADIX         # e.g., "react", "nestjs", "tauri"
owns:
  - c:\Users\smallMark\Desktop\peaksclaw\ice-cola\packages\server\src\database/**           # 本模块专属文件
dependsOn:
...
## 基本信息
- **模块**: database
- **Owner Agent**: server-database-agent
