...
modulePath: c:\Users\smallMark\Desktop\peaksclaw\ice-cola\packages\admin\src\components      # e.g., "packages/admin/src/auth"
techStack: REACT + NESTJS + RADIX         # e.g., "react", "nestjs", "tauri"
owns:
  - c:\Users\smallMark\Desktop\peaksclaw\ice-cola\packages\admin\src\components/**           # 本模块专属文件
dependsOn:
...
## 基本信息
- **模块**: components
- **Owner Agent**: admin-components-agent
