...
modulePath: c:\Users\smallMark\Desktop\peaksclaw\ice-cola\packages\admin\src\services      # e.g., "packages/admin/src/auth"
techStack: REACT + NESTJS + RADIX         # e.g., "react", "nestjs", "tauri"
owns:
  - c:\Users\smallMark\Desktop\peaksclaw\ice-cola\packages\admin\src\services/**           # 本模块专属文件
dependsOn:
...
## 基本信息
- **模块**: services
- **Owner Agent**: admin-services-agent
