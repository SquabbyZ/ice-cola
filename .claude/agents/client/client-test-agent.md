...
```yaml
# 动态注入的配置
module: test           # e.g., "auth", "orders", "ai-models"
modulePath: c:\Users\smallMark\Desktop\peaksclaw\ice-cola\packages\client\src\test      # e.g., "packages/admin/src/auth"
techStack: REACT + NESTJS + RADIX         # e.g., "react", "nestjs", "tauri"
owns:
  - c:\Users\smallMark\Desktop\peaksclaw\ice-cola\packages\client\src\test/**           # 本模块专属文件
dependsOn:
