...
- Apply project-local conventions before generic javascript guidance.
- Keep public APIs typed or documented according to javascript ecosystem norms.
...
- peaks-rd must check this file before planning code changes in javascript projects.
