  ...
  return (
    <div className="flex-1 overflow-y-auto bg-gray-50">
      <div className="p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">MCP 市场</h1>
          <p className="text-gray-600">发现 Model Context Protocol 服务，连接外部工具和数据源</p>
        </div>
        ...
        <div className="text-center py-16">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">MCP 市场待接入</h3>
          <p className="text-gray-500 mb-6">连接外部工具和数据源的功能即将推出</p>
