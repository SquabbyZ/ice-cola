...
OpenClaw Server 是一个基于 NestJS 的后端服务，为 OpenClaw Desktop 提供 API 网关、配额管理和 AI 集成能力。
...
- **openclaw-server**: NestJS API 服务（端口 3000）
...
# 运行数据库迁移
docker-compose exec openclaw-server npx prisma migrate deploy
```
